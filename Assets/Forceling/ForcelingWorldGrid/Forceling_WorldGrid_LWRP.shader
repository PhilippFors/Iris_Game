    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float4 triplanar10 = TriplanarSamplingSF( _1mGrid, WorldSpacePosition, WorldSpaceNormal, 1.0, 0.5, 1.0, 0 );
				float4 triplanar11 = TriplanarSamplingSF( _10mGrid, WorldSpacePosition, WorldSpaceNormal, 1.0, 0.05, 1.0, 0 );
				...
				float4 triplanar21 = TriplanarSamplingSF( _100mGrid, WorldSpacePosition, WorldSpaceNormal, 1.0, 0.005, 1.0, 0 );
				...
				float4 triplanar25 = TriplanarSamplingSF( _1kmGrid, WorldSpacePosition, WorldSpaceNormal, 1.0, 0.0005, 1.0, 0 );
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN  ) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float4 triplanar11 = TriplanarSamplingSF( _10mGrid, ase_worldPos, ase_worldNormal, 1.0, 0.05, 1.0, 0 );
           		float4 blendOpSrc20 = triplanar10;
           		float4 blendOpDest20 = triplanar11;
           		float temp_output_8_0 = distance( ase_worldPos , _WorldSpaceCameraPos );
           		float4 lerpResult32 = lerp( triplanar10 , lerp(triplanar10,( saturate( (( blendOpDest20 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest20 ) * ( 1.0 - blendOpSrc20 ) ) : ( 2.0 * blendOpDest20 * blendOpSrc20 ) ) )),_Use10m1) , saturate( pow( ( temp_output_8_0 / 13.0 ) , 15.0 ) ));
           		float4 triplanar21 = TriplanarSamplingSF( _100mGrid, ase_worldPos, ase_worldNormal, 1.0, 0.005, 1.0, 0 );
           		float4 blendOpSrc28 = triplanar10;
           		float4 blendOpDest28 = triplanar21;
           		float4 lerpResult37 = lerp( lerpResult32 , lerp(lerp(triplanar10,( saturate( (( blendOpDest20 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest20 ) * ( 1.0 - blendOpSrc20 ) ) : ( 2.0 * blendOpDest20 * blendOpSrc20 ) ) )),_Use10m1),( saturate( (( blendOpDest28 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest28 ) * ( 1.0 - blendOpSrc28 ) ) : ( 2.0 * blendOpDest28 * blendOpSrc28 ) ) )),_Use100m1) , saturate( pow( ( temp_output_8_0 / 80.0 ) , 10.0 ) ));
           		float4 triplanar25 = TriplanarSamplingSF( _1kmGrid, ase_worldPos, ase_worldNormal, 1.0, 0.0005, 1.0, 0 );
           		float4 blendOpSrc31 = triplanar10;
           		float4 blendOpDest31 = triplanar25;
           		float4 lerpResult38 = lerp( lerpResult37 , lerp(lerp(triplanar10,( saturate( (( blendOpDest20 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest20 ) * ( 1.0 - blendOpSrc20 ) ) : ( 2.0 * blendOpDest20 * blendOpSrc20 ) ) )),_Use10m1),( saturate( (( blendOpDest31 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest31 ) * ( 1.0 - blendOpSrc31 ) ) : ( 2.0 * blendOpDest31 * blendOpSrc31 ) ) )),_Use1km1) , saturate( pow( ( temp_output_8_0 / 800.0 ) , 10.0 ) ));
...
/*ASEBEGIN
Version=17101
2560;273;1906;1005;4203.916;1072.897;1.880421;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-3195.442,-259.5654;Float;False;Constant;_Tiling1m1;Tiling1m;2;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-3194.067,-667.2015;Float;False;Constant;_Tiling11;Tiling10;3;0;Create;True;0;0;False;0;0.05;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;11;-2837.06,-650.073;Inherit;True;Spherical;World;False;10m Grid;_10mGrid;white;4;Assets/Forceling/ForcelingWorldGrid/Forceling_Grid_10m.tga;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;False;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TriplanarNode;10;-2822.995,-235.9943;Inherit;True;Spherical;World;False;1m Grid;_1mGrid;gray;3;Assets/Forceling/ForcelingWorldGrid/Forceling_Grid_1m.tga;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;False;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;15;-3178.959,-987.4501;Float;False;Constant;_Tiling101;Tiling100;3;0;Create;True;0;0;False;0;0.005;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-3119.139,-1415.032;Float;False;Constant;_Tiling;Tiling1000;3;0;Create;True;0;0;False;0;0.0005;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;21;-2821.952,-970.321;Inherit;True;Spherical;World;False;100m Grid;_100mGrid;white;5;Assets/Forceling/ForcelingWorldGrid/Forceling_Grid_100m.tga;Mid Texture 2;_MidTexture2;white;-1;None;Bot Texture 2;_BotTexture2;white;-1;None;Triplanar Sampler;False;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT;1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;33;-1566.793,-857.6957;Float;False;Property;_Use100m1;Use 100m;1;0;Create;True;0;0;False;0;1;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SaturateNode;34;-1713.615,835.2711;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;35;-1555.011,-1278.415;Float;False;Property;_Use1km1;Use 1km;2;0;Create;True;0;0;False;0;1;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=A8E4881C53CF96F9E06E583B695F686D09C6172F